...
var youtuVedio = {
    ...
    ResetVedio: function (pagenum,leng,classID,channel) {
        ...
        $.ajax({
            type: "GET",
            url: "youtu/front/vedio/hots?countryId=8&classId="+classID+"&pageNum=" + pagenum + "&pageSize=" + leng,
    ...
    Vedioajax: function () {
        $.ajax({
            type: "GET",
            url: "youtu/front/vedio/hots?orderSort=likes&countryId=8&classId=&pageNum=1&pageSize=10",
            success: function (data) {
                //数据绑定
        ...
        $.ajax({
            type: "GET",
            url: "youtu/front/vedio/hots?countryId=8&classId=16&pageNum=1&pageSize=5",
            success: function (data) {
                //数据绑定
        ...
        $.ajax({
            type: "GET",
            url: "youtu/front/vedio/hots?countryId=8&classId=21&pageNum=1&pageSize=10",
            success: function (data) {
                //数据绑定
        ...
        $.ajax({
            type: "GET",
            url: "youtu/front/vedio/hots?countryId=8&classId=18&pageNum=1&pageSize=10",
            success: function (data) {
                //数据绑定
        ...
        $.ajax({
            type: "GET",
            url: "youtu/front/vedio/hots?countryId=8&classId=20&pageNum=1&pageSize=10",
            success: function (data) {
                //数据绑定
        ...
        $.ajax({
            type: "GET",
            url: "youtu/front/vedio/hots?countryId=8&classId=17&pageNum=1&pageSize=10",
            success: function (data) {
                //数据绑定
        ...
        $.ajax({
            type: "GET",
            url: "youtu/front/vedio/hots?countryId=8&classId=23&pageNum=1&pageSize=5",
            success: function (data) {
                //数据绑定
        ...
        $.ajax({
            type: "GET",
            url: "youtu/front/vedio/hots?countryId=8&classId=22&pageNum=1&pageSize=5",
            success: function (data) {
                //数据绑定
        ...
        $.ajax({
            type: "GET",
            url: "youtu/front/vedio/hots?countryId=8&classId=19&pageNum=1&pageSize=5",
            success: function (data) {
                //数据绑定
