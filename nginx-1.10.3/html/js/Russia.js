...
var youtuVedio = {
    ...
    ResetVedio: function (pagenum,leng,classID,channel) {
        ...
        $.ajax({
            type: "GET",
            url: "youtu/front/vedio/hots?countryId=10&classId="+classID+"&pageNum=" + pagenum + "&pageSize=" + leng,
    ...
    Vedioajax: function () {
        $.ajax({
            type: "GET",
            url: "youtu/front/vedio/hots?orderSort=likes&countryId=10&classId=&pageNum=1&pageSize=10",
            success: function (data) {
                //数据绑定
        ...
        $.ajax({
            type: "GET",
            url: "youtu/front/vedio/hots?countryId=10&classId=16&pageNum=1&pageSize=5",
            success: function (data) {
                //数据绑定
        ...
        $.ajax({
            type: "GET",
            url: "youtu/front/vedio/hots?countryId=10&classId=21&pageNum=1&pageSize=10",
            success: function (data) {
                //数据绑定
        ...
        $.ajax({
            type: "GET",
            url: "youtu/front/vedio/hots?countryId=10&classId=18&pageNum=1&pageSize=10",
            success: function (data) {
                //数据绑定
        ...
        $.ajax({
            type: "GET",
            url: "youtu/front/vedio/hots?countryId=10&classId=20&pageNum=1&pageSize=10",
            success: function (data) {
                //数据绑定
        ...
        $.ajax({
            type: "GET",
            url: "youtu/front/vedio/hots?countryId=10&classId=17&pageNum=1&pageSize=10",
            success: function (data) {
                //数据绑定
        ...
        $.ajax({
            type: "GET",
            url: "youtu/front/vedio/hots?countryId=10&classId=23&pageNum=1&pageSize=5",
            success: function (data) {
                //数据绑定
        ...
        $.ajax({
            type: "GET",
            url: "youtu/front/vedio/hots?countryId=10&classId=22&pageNum=1&pageSize=5",
            success: function (data) {
                //数据绑定
        ...
        $.ajax({
            type: "GET",
            url: "youtu/front/vedio/hots?countryId=10&classId=19&pageNum=1&pageSize=5",
            success: function (data) {
                //数据绑定
