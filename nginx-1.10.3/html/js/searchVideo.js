    ...
    Page: function (address, commentLength, pageIndex, eventCount, navigateCount, keyword) {
        ...
        $(".pageNumber").click(function () {
            if ($(this).text() != pageIndex) {
                window.location.href = ("searchVideo.html?keyword=" + keyword + "&page=" + $(this).text())
            }
        });
        $(".list-page>.prev").click(function () {
            window.location.href = ("searchVideo.html?keyword=" + keyword + "&page=" + (pageIndex - 1))

        });
        $(".list-page>.next").click(function () {
            window.location.href = ("searchVideo.html?keyword=" + keyword + "&page=" + (pageIndex - 0 + 1))
        });
    }
};
var Header = {
